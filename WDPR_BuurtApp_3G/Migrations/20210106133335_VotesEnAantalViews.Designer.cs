...
namespace WDPR_BuurtApp_3G.Migrations
{
    ...
    [Migration("20210106133335_VotesEnAantalViews")]
    partial class VotesEnAantalViews
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WDPR_BuurtApp_3G.Models.Vote", b =>
                {
                    b.Property<string>("UserID")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.Property<int>("ReactieMeldingID")
                        .HasColumnType("int");

                    b.Property<string>("ReactieUserID")
                        .IsRequired()
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");

                    b.HasKey("UserID", "ReactieID");

                    b.HasIndex("ReactieUserID", "ReactieMeldingID");
            ...
            modelBuilder.Entity("WDPR_BuurtApp_3G.Models.Vote", b =>
                {
                    ...
                    b.HasOne("WDPR_BuurtApp_3G.Models.Reactie", "Reactie")
                        .WithMany("Votes")
                        .HasForeignKey("ReactieUserID", "ReactieMeldingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
